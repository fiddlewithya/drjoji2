...
CERT_DIR = "/data/certificates"  # Render disk mount path
LOGO_PATH = "Logo.png"  # Ensure file name matches exactly (case-sensitive)
...
def generate_clean_medical_certificate_v2(patient_name, nric, rest_days):
    ...
    draw_centered("Medical Certificate", height - 280, size=16, bold=True)
